...
import com.example.springbootsample.config.security.admin.AdminAuthenticationFailureHandler;
import com.example.springbootsample.config.security.admin.AdminAuthenticationProvider;
import com.example.springbootsample.config.security.admin.AdminAuthenticationSuccessHandler;
import com.example.springbootsample.config.security.admin.CustomAdminUserDetailsService;
import com.example.springbootsample.config.security.auth.AuthFailureHandler;
import com.example.springbootsample.config.security.auth.AuthService;
import com.example.springbootsample.config.security.auth.AuthSuccessHandler;
import com.example.springbootsample.config.security.user.*;
